...
const DashboardCategoryLoading = () => {
    return (
      <div className="bg-[#18181B] text-white rounded-lg shadow-md overflow-hidden">
        <div className="relative w-full h-48 bg-gray-100 animate-pulse"></div>
        <div className="p-4">
          <div className="w-3/4 h-6 bg-gray-100 animate-pulse mb-2"></div>
          <div className="w-1/2 h-4 bg-gray-100 animate-pulse"></div>
        </div>
